...
def fuck():
    ...
    with ThreadPool(max_workers=100) as MUEOR:
        ...
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY JIBON JOIN MY GROUP ')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sJIBON\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
